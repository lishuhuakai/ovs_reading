...
struct dpif { /* datapath接口 */
   /* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    const struct dpif_class *dpif_class; /* 相关的处理函数  */
    char *base_name;
    char *full_name;
...
/* dpif_class一共有两个实现:
 * 一个是dpif_netlink_class
 * 另外一个是 dpif_netdev_class
 */
struct dpif_class {
     ...
     * names to it.
     * 枚举所有已知的，已经创建了的datapath
     *
     * This is used by the vswitch at startup, so that it can delete any
     * datapaths that are not configured.
     * 这个用在vswitch启动的时候，如果发现有的datapath没有配置的话，可以删掉这个datapath
     *
     ...
     * 添加netdev，将其作为dpif的新端口, port_no为端口值
     */
