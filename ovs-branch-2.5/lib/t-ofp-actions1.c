...
BUILD_ASSERT_DECL(sizeof(struct nx_action_reg_load2) % OFP_ACTION_ALIGN == 0);
...
static struct ofpact_raw_instance all_raw_instances[] = {
    ...
    { { 0x00002320, 33, 0x01 }, 
      ...
      HMAP_NODE_NULL_INITIALIZER,
      HMAP_NODE_NULL_INITIALIZER,
      sizeof(struct nx_action_reg_load2),
      65536 - OFP_ACTION_ALIGN,
      0,
      0,
      "NXAST_REG_LOAD2",
...
put_OFPAT11_GROUP(struct ofpbuf *openflow, uint32_t arg){
    ofpact_put_raw(openflow, 2, OFPAT_RAW11_GROUP, arg);
}
...
{
    switch (raw) {
    case OFPAT_RAW_SET_TP_SRC: /* 设置源端口 */
        return decode_OFPAT_RAW_SET_TP_SRC(htons(arg), version, out);

    case NXAST_RAW_CT:
        return decode_NXAST_RAW_CT(ALIGNED_CAST(const struct nx_action_conntrack *, a), version, out);
    ...
    case OFPAT_RAW15_COPY_FIELD:
        return decode_OFPAT_RAW15_COPY_FIELD(ALIGNED_CAST(const struct ofp15_action_copy_field *, a), version, out);
    ...
    case NXAST_RAW_MULTIPATH:
        return decode_NXAST_RAW_MULTIPATH(ALIGNED_CAST(const struct nx_action_multipath *, a), version, out);
    ...
    case ONFACT_RAW13_COPY_FIELD:
        return decode_ONFACT_RAW13_COPY_FIELD(ALIGNED_CAST(const struct onf_action_copy_field *, a), version, out);

    case NXAST_RAW_LEARN:
        return decode_NXAST_RAW_LEARN(ALIGNED_CAST(const struct nx_action_learn *, a), version, out);
    ...
    case OFPAT_RAW15_SET_FIELD:
        return decode_OFPAT_RAW15_SET_FIELD(ALIGNED_CAST(const struct ofp12_action_set_field *, a), version, out);
    ...
    case NXAST_RAW_REG_MOVE:
        return decode_NXAST_RAW_REG_MOVE(ALIGNED_CAST(const struct nx_action_reg_move *, a), version, out);

    case NXAST_RAW_STACK_POP:
        return decode_NXAST_RAW_STACK_POP(ALIGNED_CAST(const struct nx_action_stack *, a), version, out);
    ...
    case OFPAT_RAW12_SET_FIELD:
        return decode_OFPAT_RAW12_SET_FIELD(ALIGNED_CAST(const struct ofp12_action_set_field *, a), version, out);

    case NXAST_RAW_BUNDLE_LOAD:
        return decode_NXAST_RAW_BUNDLE_LOAD(ALIGNED_CAST(const struct nx_action_bundle *, a), version, out);

    case NXAST_RAW_OUTPUT_REG:
        return decode_NXAST_RAW_OUTPUT_REG(ALIGNED_CAST(const struct nx_action_output_reg *, a), version, out);
    ...
    case NXAST_RAW_REG_LOAD:
        return decode_NXAST_RAW_REG_LOAD(ALIGNED_CAST(const struct nx_action_reg_load *, a), version, out);
    ...
    case OFPAT_RAW11_GROUP:
        return decode_OFPAT_RAW11_GROUP(arg, version, out);

    case NXAST_RAW_STACK_PUSH:
        return decode_NXAST_RAW_STACK_PUSH(ALIGNED_CAST(const struct nx_action_stack *, a), version, out);
    ...
    case NXAST_RAW_OUTPUT_REG2:
        return decode_NXAST_RAW_OUTPUT_REG2(ALIGNED_CAST(const struct nx_action_output_reg2 *, a), version, out);

    case NXAST_RAW_REG_LOAD2:
        return decode_NXAST_RAW_REG_LOAD2(ALIGNED_CAST(const struct nx_action_reg_load2 *, a), version, out);
